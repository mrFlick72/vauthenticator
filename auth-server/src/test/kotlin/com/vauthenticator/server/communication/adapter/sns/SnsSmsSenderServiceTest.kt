...
class SnsSmsSenderServiceTest {
    ...
    fun `happy path`() {
        ...
        val phoneNumber = account.phone?.formattedPhone() ?: "+39 339 2323233"
        every { smsMessageFactory.makeSmsMessageFor(account, emptyMap()) } returns SmsMessage(phoneNumber, "it is an sms message")
